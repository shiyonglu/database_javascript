...
5. CREATE 10 tables using SQL create table statements inside XAMPP/mysql
6. INSERT at least 10 tuples in each of the table. 
7. Execute 10 SELECT statement such that each statement will join at least two tables. TWo of them should be generated by ChatGpt,
8. but you need to explain their meanings (what are returned) to deserve full credits. 
